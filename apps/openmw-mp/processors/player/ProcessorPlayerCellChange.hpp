...
namespace mwmp
{
    ...
    public:
        ...
        {
            LOG_MESSAGE_SIMPLE(MWMPLog::LOG_INFO, "Received %s from %s", strPacketID.c_str(), player.npc.mName.c_str());
            LOG_APPEND(MWMPLog::LOG_INFO, "- Moved to %s", player.cell.getDescription().c_str());
            ...
            player.forEachLoaded([this](Player *pl, Player *other) {
                ...
                LOG_APPEND(MWMPLog::LOG_INFO, "- Started information exchange with %s", other->npc.mName.c_str());
                ...
                LOG_APPEND(MWMPLog::LOG_INFO, "- Finished information exchange with %s", other->npc.mName.c_str());
            });
            ...
            LOG_APPEND(MWMPLog::LOG_INFO, "- Finished processing ID_PLAYER_CELL_CHANGE", player.cell.getDescription().c_str());
